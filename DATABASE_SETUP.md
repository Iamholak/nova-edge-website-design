...
Go to your **Supabase Dashboard** → **SQL Editor** and run this complete SQL:
...
## Step 3: Update Stats (Optional)

Once logged in, go to `/admin/stats` to update:
- Clients Satisfied (%)
- Projects Delivered (number)
- Team Members (number)
- Years of Experience (number)

These will automatically appear on the home page.
...
- Make sure you ran the entire SQL above
- Try refreshing your browser
- Check Supabase SQL Editor for any error messages during execution

**Login not working?**
- Verify the `admin_users` table has a row
- Try clearing browser cookies
- Check that email is exactly `admin@novaedge.com`

**Stats not showing?**
- The API returns default values (50, 120, 15, 5) until database is set up
- Once migration runs, real values from database will show
